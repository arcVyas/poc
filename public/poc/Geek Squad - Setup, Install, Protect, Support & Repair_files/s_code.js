...
s.linkInternalFilters=Lm.config.linkInternalFilters;
...
s.visitorNamespace=Lm.config.visitorNamespace;

s.trackingServer=Lm.config.trackingServer;
s.trackingServerSecure=Lm.config.trackingServerSecure;
s.dc=122;
...
try{Lm.s_code=s;Lm.LOAD("s_code")}catch(e){};
